...
class Classifier3x150x150_target(nn.Module):
    def __init__(self, num_channels=3, num_feats=512, num_classes=8):
        super(Classifier3x150x150_target, self).__init__()
        KERNEL_SIZE = (3, 3)
...
class Classifier3x150x150_surrogate(nn.Module):
    def __init__(self, num_channels=3, num_feats=512, num_classes=8):
        super(Classifier3x150x150_surrogate, self).__init__()
        KERNEL_SIZE = (3, 3)
