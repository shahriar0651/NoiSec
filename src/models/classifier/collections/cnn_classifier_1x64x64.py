...
class Classifier1x64x64_target(nn.Module):
    def __init__(self, num_channels=1, num_feats=256, num_classes=2):
        super(Classifier1x64x64_target, self).__init__()
        KERNEL_SIZE = (3, 3)
...
class Classifier1x64x64_surrogate(nn.Module):
    def __init__(self, num_channels=1, num_feats=256, num_classes=35):
        super(Classifier1x64x64_surrogate, self).__init__()
        KERNEL_SIZE = (3, 3)
